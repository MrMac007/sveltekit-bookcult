...
<div class="flex min-h-screen items-center justify-center px-6 py-12">
	...
	<Card class="w-full max-w-md">
		<CardHeader class="space-y-1 text-center">
			...
			<CardTitle class="page-heading text-2xl">Create an account</CardTitle>
			<CardDescription class="text-sm text-muted-foreground">
				Begin your reading journey with new worlds to explore.
			</CardDescription>
		</CardHeader>
		<CardContent class="space-y-4">
			...
			<form onsubmit={handleEmailSignUp} class="space-y-4" name="bookcult-signup" data-form-type="bookcult-registration">
				<div class="space-y-2">
